...
class _OnboardingScreenState extends State<OnboardingScreen>
  ...
  Widget _buildHeroImage(
    ...
    // SizedBox.expand ensures the container takes all available space from parent
      ...
      child: Container(
        ...
        child: ClipRRect(
          ...
          child: Stack(
            fit: StackFit.expand,
            children: [
              // Image - use width/height constraints for proper rendering
              Positioned.fill(
                child: Image.asset(
                  content.image,
                  fit: BoxFit.cover,
                  errorBuilder: (context, error, stackTrace) {
                    debugPrint('Image load error: $error for ${content.image}');
                    return Container(
                      decoration: BoxDecoration(
