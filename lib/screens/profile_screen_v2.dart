/// 👤 ULTRA-PREMIUM PROFILE SCREEN V2 - 2026 DESIGN WITH REAL API
///
/// Features:
/// ✅ Real API data from ProfileProvider
/// ✅ Liquid Glass Profile Card
/// ✅ Animated Background Particles
/// ✅ Role-specific stats (Artist: Rating, Reviews, Gigs | Venue: Rating, Reviews, Capacity)
...
class _ProfileScreenV2State extends State<ProfileScreenV2>
                  ...
                  child: CustomScrollView(
                    ...
                    slivers: [
                      ...
                      if (profile.isLoading &&
                          profile.status == ProfileStatus.initial)
                        ...
                        SliverToBoxAdapter(
                          child: Padding(
                            ...
                            child: TextButton(
                              onPressed: () =>
                                  _showLogoutDialog(context, brightness),
  ...
  Widget _buildStatCard(
    ...
    final animation = Tween<double>(begin: 0.0, end: 1.0).animate(
      CurvedAnimation(
        ...
        curve: Interval(0.2 + (index * 0.1), 0.8, curve: Curves.easeOutBack),
      ),
    );
  ...
  Widget _buildMenuItem(
    ...
    final opacity = Tween<double>(begin: 0.0, end: 1.0).animate(
      CurvedAnimation(
        parent: _slideController,
        curve: Interval(0.3 + (index * 0.05), 0.8),
      ),
    );
        ...
        actions: [
          ...
          TextButton(
            onPressed: () async {
              ...
              // Clear profile data
              if (!mounted) return;
              this.context.read<ProfileProvider>().clear();
