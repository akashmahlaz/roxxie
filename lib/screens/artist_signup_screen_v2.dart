/// 🎸 ULTRA-PREMIUM ARTIST SIGNUP SCREEN V2 - 2026 DESIGN
///
/// Features:
...
class _ArtistSignupScreenV2State extends State<ArtistSignupScreenV2>
  ...
  // Particles
  final List<_SignupParticle> _particles = [];
...
class _ParticleFieldPainter extends CustomPainter {
  final List<_SignupParticle> particles;
